...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_contacto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('email', self.gf('django.db.models.fields.CharField')(default='ejemplo@mail.com', max_length=50)),
            ('comentario', self.gf('django.db.models.fields.TextField')(max_length=50)),
        ))
        db.send_create_signal(u'app', ['Contacto'])


    def backwards(self, orm):
        # Deleting model 'Contacto'
        db.delete_table(u'app_contacto')
